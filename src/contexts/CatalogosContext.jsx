...
function normalizar(c) {
  ...
  let metodos_pago = Array.isArray(c?.metodos_pago) ? c.metodos_pago : SEED.metodos_pago
  // Quitar tarjeta si existe (migración)
  metodos_pago = metodos_pago.filter(m => m.value !== 'tarjeta')
  return {
